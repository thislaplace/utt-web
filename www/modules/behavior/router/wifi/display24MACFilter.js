define(function(require, exports, module){
	...
	function changeRule(nowmacfilter){
		...
		$.ajax({
			type:"POST",
			url:"/goform/ConfigWlanMacFilterGlobalConfig",
			data:dataStr,
	...
	function display($con){
		...
		$.ajax({
			type:"get",
			url:"common.asp?optType=getWlanMacFilterMacList",
			success:function(result){
				...
				var $onoff = OnOff.getDom({
					prevWord:'2.4G'+tl('wifiMACFilter'),
					afterWord:'',
					id:'macfilter',
	...
	*/
	function deletFunc(deletearr){
		...
		str = str.substr(0,str.length-1);
		 $.ajax({
          url: '/goform/ConfigWlanMacFilterDel',
          type: 'POST',
          data: str,
          success: function(result) {
            var doEval = require('Eval');
			...
			"btns" : [
	            {
	                ...
	                "clickFunc" : function($this){
            			...
            			$.ajax({
							type:"POST",
							url: "/goform/ConfigWlanMacFilter",
							data:datastr,
							success:function(result){
								 var doEval = require('Eval');
